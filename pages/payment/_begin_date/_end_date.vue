        ...
        <v-flex>
            <v-card color="grey lighten-4">
                ...
                <v-layout wrap class="selectors">
                    ...
                    <v-flex xs12 sm6 md4>
                        <v-text-field label="Всего (без вычета скидки)" outline
                                      :value="response.cur_sum"></v-text-field>
                    </v-flex>
                    <v-flex xs12 sm6 md4>
                        <v-text-field label="Всего (с вычетом скидки)" outline
                                      :value="response.cur_sum - response.discount_sum"></v-text-field>
                    </v-flex>
                    <v-flex xs12 sm6 md4>
                        <v-text-field label="Всего скидка" outline :value="response.discount_sum"></v-text-field>
                    </v-flex>
                    <v-flex xs12 sm6 md4>
                        <v-text-field label="Всего без предоплат" outline
                                      :value="response.sum_without_pred"></v-text-field>
                    </v-flex>
                    <v-flex xs12 sm6 md4>
                ...
                <table id="DataTable" ref="DataTable" class="table table-striped table-bordered"
                    ...
                    <tbody>
                    <tr v-for="room in response.order_rooms" @click="getReservation(room.order_num)">
