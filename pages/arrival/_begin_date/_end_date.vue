        ...
        <v-flex>
            <v-card color="grey lighten-4">
                <v-toolbar prominent class="no-shadow">
                    <v-toolbar-title>Отчет по заездам</v-toolbar-title>
                    <v-spacer/>
                    <span>C </span>
                    <v-dialog
                ...
                >
                    ...
                    <tr>
                        ...
                        <th class="export">Сумма к оплате</th>
                        <th class="export">Телефон</th>
                        <th class="export">Примечание</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr v-for="room in response.order_rooms">
                        ...
                        <td data-field="arrival_days">{{ room.count_days }}</td>
                        <td data-field="adult">{{ room.adult }}</td>
                        <td data-field="kids">{{ room.kids }}</td>
                        <td data-field="summ">{{ room.total_payment }}</td>
                        <td data-field="phone">{{ room.client.phone }}</td>
                        <td data-field="note">{{ room.info_transfer }}</td>
                    </tr>
                    </tbody>
                </table>
            </v-card>
